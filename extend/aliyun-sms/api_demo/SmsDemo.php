...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4FiHXWSSv21VSFFAnQNJ"; // AccessKeyId

        $accessKeySecret = "0iF3h5zhur6QWoSBpZfWKe04OnFiOw"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone, $smTemplate, $smsTemplateValue) {
        ...
        $request->setSignName("肖友强");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode($smTemplate);

        // 可选，设置模板参数, 假如模板中存在变量需要替换则为必填项
        $request->setTemplateParam(json_encode($smsTemplateValue, JSON_UNESCAPED_UNICODE));
